...
////        BitConverter.ToUInt32(source, 0)
//
//    let rec mixitLowerThan16 ((a:uint64), (b:uint64), (c:uint64), (d:uint64)) (remain:byte array) =
//        match remain.Length with
//        |   15  ->
//            let d = d + (uint64(remain.[14]) <<< 48)
//            mixitLowerThan16 (a,b,c,d) (remain |> Array.skip 1)
//        |   14  ->
...
//
//        let mixValues = End remainData mixValues
//
//        (h0, h1)
//
////
...
UInt64.Parse("deadbeefdeadbeef", NumberStyles.AllowHexSpecifier)
sprintf "0x%x" 16045690984833335023UL ="0xdeadbeefdeadbeef"
...
UInt32.Parse("70de1d26", NumberStyles.AllowHexSpecifier)
uint32(16045690984833335023UL)
1 <<< 56
